<?php
$cfg_basehost = 'http://kawa.com';
$cfg_cmspath = '';
$cfg_cookie_encode = 'DpUNw6926V';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '首页';
$cfg_webname = 'Chongqing Kava Auto Electrial Co.,Ltd';
$cfg_adminemail = '';
$cfg_html_editor = 'ckeditor';
$cfg_arcdir = '';
$cfg_medias_dir = '/upload';
$cfg_ddimg_width = 120;
$cfg_ddimg_height = 110;
$cfg_domain_cookie = '';
...
$cfg_fck_xhtml = 'N';
$cfg_df_style = 'gemelsoft';
$cfg_multi_site = 'N';
$cfg_gemel_log = 'N';
$cfg_powerby = 'Copyright &copy; 2017 Chongqing Kava Auto Electrial Co.,Ltd.';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_mb_rmdown = 'Y';
$cfg_cli_time = 8;
$cfg_mb_addontype = 'swf|mpg|mp3|rm|rmvb|wmv|wma|wav|mid|mov|zip|rar|doc|xls|ppt|wps';
$cfg_mb_max = 500;
$cfg_keyword_like = 'N';
$cfg_index_max = 10000;
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = 'Starter Motor, Auto Alternator';
$cfg_description = 'Chongqing Kava Auto Electrical Co., Ltd., a professional manufacturer and exporter, has been established in 2001, specializing in starter and alternator.';
$cfg_beian = '';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
