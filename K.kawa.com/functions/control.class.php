...
class Control
{
    ...
    {
        global $dsql;
        $this->tpl = isset($this->tpl)? $this->tpl : new GemelTemplate();
        $sqltype = "GemelSql";
        if ($GLOBALS['cfg_mysql_type'] == 'mysqli' && function_exists("mysqli_init")) $sqltype = "GemelSql";
        else $sqltype = "GemelSqli";
    ...
    {
        $tplfile = GEMELAPPTPL.'/'.$this->style.'/'.$tplfile;
