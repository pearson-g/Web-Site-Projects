...
$filename_name =  $fileNames; //$cuserLogin->getUserID().'-'.dd2char(MyDate("ymdHis", $nowtme).mt_rand(100,999));
...
{
    //分析远程文件路径
    $remotefile = str_replace(GEMELROOT, '', $fullfilename);
