...
require_once(GEMELINC."/splitword.class.php");
require_once(GEMELINC."/taglib/hotwords.lib.php");
require_once(GEMELINC."/taglib/channel.lib.php");
require_once(GEMELINC."/taglib/rpad.lib.php");
require_once(GEMELINC."/taglib/type.lib.php");
