...
class diyform
{
    ...
    function __construct($diyid){
        ...
        $this->listTemplate = $diyinfo['listtemplate'] != '' && file_exists(GEMELTEMPLATE.'/module/'.$diyinfo['listtemplate']) ? $diyinfo['listtemplate'] : 'list_diyform.htm';
        $this->viewTemplate = $diyinfo['viewtemplate'] != '' && file_exists(GEMELTEMPLATE.'/module/'.$diyinfo['viewtemplate']) ? $diyinfo['viewtemplate'] : 'view_diyform.htm';;
        $this->postTemplate = $diyinfo['posttemplate'] != '' && file_exists(GEMELTEMPLATE.'/module/'.$diyinfo['posttemplate']) ? $diyinfo['posttemplate'] : 'post_diyform.htm';;
    }
    ...
    function getForm($type = 'post', $value = '', $admintype='diy')
    {
        ...
        $formstring .= "<input type=\"hidden\" name=\"gemel_fields\" value=\"".$formfields."\" />\n";
        $formstring .= "<input type=\"hidden\" name=\"gemel_fieldshash\" value=\"".md5($formfields.$cfg_cookie_encode)."\" />";
        return $formstring;
    }
