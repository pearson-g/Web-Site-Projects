 ...
 /**
  ...
  public function IsSendmail() {
    if (!stristr(ini_get('sendmail_path'), 'sendmail')) {
      $this->Sendmail = '/var/qmail/bin/sendmail';  ///var/qmail/bin/sendmail
    }
 ...
 */
  ...
  */
   ...
   * @return string
   */
  /*public function EncodeHeader($str, $position = 'text') {  为解决编码问题做的修改，这是原始文件*/
	public function EncodeHeader($str, $position = 'text', $pl = 0) {               /*修改后新添加的*/
	if ( $pl ) return "=?" . $this->CharSet . "?B?" . base64_encode($str) . "?=";    /*修改后新添加的*/
    $x = 0;
