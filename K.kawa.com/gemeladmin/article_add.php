...
if(file_exists(GEMELDATA.'/template.rand.php'))
{
    require_once(GEMELDATA.'/template.rand.php');
}
...
if($dopost!='save')
{
    ...
    {
        require_once(GEMELADMIN."/inc/inc_coonepage.php");
    ...
    include GEMELINClude("templets/article_add.htm");
    exit();
}
