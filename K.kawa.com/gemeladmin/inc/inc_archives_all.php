...
function GetFieldValue($dvalue,$dtype,$aid=0,$job='add',$addvar='')
{
    ...
    else if($dtype=="img")
    {
        ...
        $imgurl = "{gemel:img text='' width='' height=''} ".$iurl." {/gemel:img}";
        if(preg_match("#^http:\/\/#i", $iurl) && $GLOBALS['isUrlOpen'])
        {
            ...
            if($isUrlOpen)
            {
                ...
                if(is_array($reimgs))
                {
                    $imgurl = "{gemel:img text='' width='".$reimgs[1]."' height='".$reimgs[2]."'} ".$reimgs[0]." {/gemel:img}";
                }
            }
            else
            {
        ...
        else if($iurl!="")
        {
            ...
            if(is_file($imgfile))
            {
                ...
                $imgurl = "{gemel:img text='' width='".$imginfos[0]."' height='".$imginfos[1]."'} $iurl {/gemel:img}";
            }
        }
