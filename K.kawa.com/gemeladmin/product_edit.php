...
if($dopost!='save')
{
    ...
    $tags = GetTags($aid);
    include GEMELINClude("templets/product_edit.htm");
    exit();
}
/*--------------------------------
function __save(){  }
...
else if($dopost=='save')
{
    ...
    {
        $useip = GetIP();
        $iquery = "UPDATE `$addtable` SET typeid='$typeid'{$inadd_f},redirecturl='$redirecturl',userip='$useip',brand='$brand' WHERE aid='$id' ";
    ...
    $msg = "
    　　请选择你的后续操作：
    <a href='product_add.php?cid=$typeid'><u>发布新文档</u></a>
    &nbsp;&nbsp;
