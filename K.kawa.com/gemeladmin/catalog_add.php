...
if($dopost=='quick')
{
    ...
    include GEMELINClude('templets/catalog_add_quick.htm');
    exit();
}
/*---------------------
...
else if($dopost=='save')
{
    ...
    ispart,corank,description,keywords,seotitle,moresite,siteurl,sitepath,ishidden,`cross`,`crossid`,`content`,`smalltypes`,typepic,open_new)
...
include GEMELINClude('templets/catalog_add.htm');