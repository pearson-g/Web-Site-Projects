...
{
	require_once GEMELINC.'/request.class.php';
	$request = new Request();
	$request->Init();
	...
	if(!empty($logoimg))
	{
		$request->MoveUploadFile('logoimg', GEMELROOT.$cfg_medias_dir.'/flink/'.$request->GetFileInfo('logoimg', 'name'));
...
include GEMELINClude('templets/friendlink_edit.htm');