...
$ImageWaterConfigFile = GEMELDATA."/mark/inc_photowatermark_config.php";
...
if($action=="save")
{
    ...
    if(is_uploaded_file($newimg))
    {
        ...
        @move_uploaded_file($newimg,GEMELDATA."/mark/".$photo_markimg);
    }
...
include GEMELINClude('templets/sys_info_mark.htm');