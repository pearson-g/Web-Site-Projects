...
else if($fmdo=="edit")
{
    ...
    $ctp->LoadTemplate(GEMELADMIN."/templets/file_edit.htm");
    $ctp->display();
}
/*编辑文件，可视化模式
else if($fmdo=="editview")
{
    ...
    $GLOBALS['filename'] = $filename;
    $ctp = new GemelTagParse();
    $ctp->LoadTemplate(GEMELADMIN."/templets/file_edit_view.htm");
    $ctp->display();
}
*/
//新建文件
...
{
    $ctp = new GemelTagParse();
    $ctp->LoadTemplate(GEMELADMIN."/templets/file_upload.htm");
    $ctp->display();
}