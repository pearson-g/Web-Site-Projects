...
index.php
gemeladmin/config.php
gemeladmin/index_body.php
gemeladmin/member_do.php
gemeladmin/sys_info_pay.php
gemeladmin/mychannel_main.php
group/postform.php
group/reply.php
...
include/gemelcollection.class.php
include/gemeltag.class.php
...
$safefile = trim(str_replace('gemeladmin/',$adminDir.'/',$safefile));
...
function TestOneFile($f)
{
    ...
    if(preg_match("#(".$info.")[ \r\n\t]{0,}([\[\(])#i", $str))
    {
        $trfile = preg_replace("#^".GEMELROOT."#", '', $f);
