 ...
 */
require(dirname(__FILE__)."/../functions/common.inc.php");
require(GEMELINC."/gemelvote.class.php");
require(GEMELINC."/memberlogin.class.php");
require(GEMELINC."/userlogin.class.php");

$member = new MemberLogin;
$memberID = $member->M_LoginID;
$time = time();
$content = $memberID.'|'.$time;
$file = GEMELDATA.'/cache/vote_'.$aid.'_'.$member->M_ID.'.inc';//存放会员投票记录的缓存文件
...
//显示模板(简单PHP文件)
include(GEMELTEMPLATE.'/module/vote.htm');