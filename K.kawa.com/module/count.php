 ...
 * <script src="{gemel:field name='phpurl'/}/count.php?view=yes&aid={gemel:field name='id'/}&mid={gemel:field name='mid'/}" language="javascript"></script>
 * 普通计数器为
 * <script src="{gemel:field name='phpurl'/}/count.php?aid={gemel:field name='id'/}&mid={gemel:field name='mid'/}" language="javascript"></script>
 *
