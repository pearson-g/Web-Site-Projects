...
if(file_exists(GEMELROOT."/templets/default/$template"))
{
    $templatefile = GEMELROOT."/templets/default/$template";
}
else
{
    $templatefile = GEMELROOT."/templets/default/advancedsearch.htm";
}
