...
if(!isset($dopost) || empty($dopost)){
    ...
    */
    ...
    } else if ($do == 'clickout')
    {
        ...
        require_once GEMELINC.'/payment/'.$rs['code'].'.php';
        $pay = new $rs['code'];
        if($rs['code']=="cod" || $rs['code']=="bank")
        {
           $order=$OrdersId;
            ...
            require_once GEMELDATA.'/payment/'.$rs['code'].'.php';
        }
...
} else if ($dopost == 'memclickout')
{
	...
	if(empty($rs['code']) OR !file_exists(GEMELINC.'/payment/'.$rs['code'].'.php'))
	{
...
} else if ($dopost == 'return')
{
    ...
    {
        require_once GEMELINC.'/payment/'.$code.'.php';
        $pay = new $code;
        $msg=$pay->respond();
